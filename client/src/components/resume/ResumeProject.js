...
import quran from '../../assets/flat-modern-holy-al-quran-vector-illustration.jpg';
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="portofolio-box">
            ...
            <div className="box-item" data-aos="flip-up">
              <img src={quran} alt="chuck-norris" />
              <div className="box-title">
                <h4>
                  <a href="https://github.com/muhammadKholid/Quran-Al-Kareem">Quran Web App</a>
                </h4>
              </div>
            </div>
            {/* <div className="box-item" data-aos="flip-up"> */}
